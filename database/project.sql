...
INSERT INTO user (userID, email, username, password, name) VALUES ( 1, "up201605240@fe.up.pt", "201605240", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Ana Rita Fonseca Santos");
INSERT INTO user (userID, email, username, password, name) VALUES ( 2, "up201206097@fe.up.pt", "201206097", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Artur Correia Alves");
INSERT INTO user (userID, email, username, password, name) VALUES ( 3, "up201604014@fe.up.pt", "201604014", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Bernardo Costa Moreira");
INSERT INTO user (userID, email, username, password, name) VALUES ( 4, "up201404616@fe.up.pt", "201404616", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Carlos Manuel Pires Bras");
INSERT INTO user (userID, email, username, password, name) VALUES ( 5, "up201706828@fe.up.pt", "201706828", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "César Alves Nogueira");
INSERT INTO user (userID, email, username, password, name) VALUES ( 6, "up201700127@fe.up.pt", "201700127", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Fellipe Ranheri de Souza");
INSERT INTO user (userID, email, username, password, name) VALUES ( 7, "up201708999@fe.up.pt", "201708999", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Filipe Reis Almeida");
INSERT INTO user (userID, email, username, password, name) VALUES ( 8, "up201704700@fe.up.pt", "201704700", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Gaspar Santos Pinheiro");
INSERT INTO user (userID, email, username, password, name) VALUES ( 9, "up201604506@fe.up.pt", "201604506", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Gonçalo António de Jesus Xavier");
INSERT INTO user (userID, email, username, password, name) VALUES (10, "up201705072@fe.up.pt", "201705072", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Gustavo Nunes Ribeiro de Magalhaes");
INSERT INTO user (userID, email, username, password, name) VALUES (11, "up201604450@fe.up.pt", "201604450", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "In Young Jang");
INSERT INTO user (userID, email, username, password, name) VALUES (12, "up201705573@fe.up.pt", "201705573", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "João Francisco de Pinho Brandão");
INSERT INTO user (userID, email, username, password, name) VALUES (13, "up201704851@fe.up.pt", "201704851", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "João Pedro da Costa Ribeiro");
INSERT INTO user (userID, email, username, password, name) VALUES (14, "up201604343@fe.up.pt", "201604343", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Luís Miguel Pedrosa de Moura Oliveira Henriques");
INSERT INTO user (userID, email, username, password, name) VALUES (15, "up201604835@fe.up.pt", "201604835", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Luís Ricardo Matos Mendes");
INSERT INTO user (userID, email, username, password, name) VALUES (16, "up201604530@fe.up.pt", "201604530", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Maria Marta Nunes Andrade Lobo dos Santos");
INSERT INTO user (userID, email, username, password, name) VALUES (17, "up201700132@fe.up.pt", "201700132", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Muriel de Araújo Pinho");
INSERT INTO user (userID, email, username, password, name) VALUES (18, "up201405687@fe.up.pt", "201405687", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Nuno Miguel Rodrigues Gomes");
INSERT INTO user (userID, email, username, password, name) VALUES (29, "up201604686@fe.up.pt", "201604686", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Ricardo França Domingues Cardoso");
INSERT INTO user (userID, email, username, password, name) VALUES (20, "up201506561@fe.up.pt", "201506561", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Rodrigo Melo Abrantes");
INSERT INTO user (userID, email, username, password, name) VALUES (21, "up201903179@fe.up.pt", "201903179", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Sara Maza Hernández");
INSERT INTO user (userID, email, username, password, name) VALUES (22, "up201704733@fe.up.pt", "201704733", "$2y$12$hpnybEfSP7t6OnwYmXXaz.i0rbxXqMm36xa59UA5BCb/.P20VVMKC", "Tiago Miguel Barbosa Marques");
...
INSERT INTO property VALUES (5, 14, "Rua do Jardim","Mealhada", "Portugal", 1, "Desfrute de umas férias cheias de leitão", 150);
INSERT INTO property VALUES (6, 14, "Rua António Martins Soares Leite ","Santa Maria da Feira", "Portugal", 3, "Casa acolhedora com vista para o castelo", 200);
...
INSERT INTO property VALUES (8, 14, "Rua Dom Afonso Henriques ","Arouca", "Portugal", 3, "Casa com vista para o monte. Excelente para desfrutar de umas férias sossegadas", 250);
...
INSERT INTO rent VALUES (4, 7, 14, "2019-10-01", "2019-10-11", "2019-09-30", 1700);
